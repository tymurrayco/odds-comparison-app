// src/app/lacrosse-ratings/components/RatingsTab.tsx
'use client';
      ...
      <div className="p-4 border-b border-gray-200 flex items-center gap-2">
        ...
        <button
          onClick={() => {
            ...
            const header = ['Rank', 'Team', 'Conference', 'Rating', 'Initial', 'Initial Rank', 'Change', 'Games'];
            const rows: string[][] = [];
            ...
            link.download = `lacrosse_ratings_${new Date().toISOString().split('T')[0]}.csv`;
            link.click();
          }}
                          ...
                          <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y divide-gray-200">
                              {teamGames.map((adj) => {
                                ...
                                const teamClosingSpread = details.isHome ? adj.closingSpread : -adj.closingSpread;
                                ...
                                return (
                                  <tr key={adj.gameId} className="hover:bg-gray-100">
                                    ...
                                    <td className="py-2 text-right font-mono text-gray-900">{formatSpread(teamClosingSpread)}</td>
