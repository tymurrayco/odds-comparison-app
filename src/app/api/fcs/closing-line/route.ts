// src/app/api/fcs/closing-line/route.ts

/**
 * POST /api/fcs/closing-line
...
import { setManualFcsClosingLine } from '@/lib/fcs/supabase';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const line = await setManualFcsClosingLine(gameId, closingSpread);
