// src/app/api/nfl/closing-line/route.ts

/**
 * POST /api/nfl/closing-line
...
import { setManualNflClosingLine } from '@/lib/nfl/supabase';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const line = await setManualNflClosingLine(gameId, closingSpread);
